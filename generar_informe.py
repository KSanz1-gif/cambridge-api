...
control of tenses, minor slips",
    "Lexical Resource": "Sufficient range for 
topic, some repetition",
    "Discourse Management": "Coherent speech 
with some hesitation",
    "Pronunciation": "Mostly intelligible, 
slight L1 influence",
    "Interactive Communication": "Responds 
appropriately, minor delays"
}
base["puntuacion_estimativa"] = {
    "Grammatical Range and Accuracy": "Good control of tenses, minor 
slips",
...
base["comentario_general"] = "A strong B2 performance with clear effort 
and control. Minor issues in grammar and pronunciation."
